...
# المكتبات الإضافية للخصائص المتقدمة
...
# ---------------------------------------------------------
# 9. الخصائص المتقدمة (الفواتير، المترجم، والتفريغ)
# ---------------------------------------------------------
...
async def voice_to_text(client, message):
    ...
    try:
        ...
        await status_msg.edit_text(f"❌ **فشل التفريغ.** تأكد من تثبيت FFmpeg على نظامك.\nالخطأ: `{e}`")

# ---------------------------------------------------------
# التشغيل النهائي للنظام
# ---------------------------------------------------------
if __name__ == "__main__":
    logger.info("تم إقلاع نظام AboElfadl الشامل بنجاح...")
    app.run()
